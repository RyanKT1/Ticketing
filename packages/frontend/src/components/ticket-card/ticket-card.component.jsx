        ...
        <nav>
            ...
            <Card.Body>
                ...
                <div className={styles.metaInfo}>
                    <Row className="mb-2">
                        <Col xs={4} className="text-muted">Owner:</Col>
                    ...
                    {ticket.deviceId ? 
                            ...
                            <Row className="mb-2">
                                <Col xs={4} className="text-muted">Device ID:</Col>
                                <Col>{ticket.deviceId}</Col>
                            </Row>
                            :
                            <>
                            <Row className="mb-2">
                                <Col xs={4} className="text-muted">Device Manufacturer:</Col>
                                <Col>{ticket.deviceManufacturer}</Col>
                            </Row>
                            <Row className="mb-2">
                                <Col xs={4} className="text-muted">Device Model:</Col>
                    ...
                    <Row className="mb-2">
                        <Col xs={4} className="text-muted">Created:</Col>
