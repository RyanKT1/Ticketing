    ...
    describe('findAllDevices', () => {
        describe('when called', () => {
            it('should return an array of devices', async () => {
                ...
                const result = await repository.findAllDevices();
        ...
        describe('when DynamoDB throws an error', () => {
            it('should propagate the error', async () => {
                ...
                await expect(repository.findAllDevices()).rejects.toThrow('DynamoDB error');
            });
        });
    });
    ...
    describe('findOneDevice', () => {
        describe('when device exists', () => {
            it('should return the device', async () => {
                ...
                const result = await repository.findOneDevice(mockDevice.id);
        ...
        describe('when device does not exist', () => {
            it('should return undefined', async () => {
                ...
                const result = await repository.findOneDevice('non-existent-id');
        ...
        describe('when DynamoDB throws an error', () => {
            it('should propagate the error', async () => {
                ...
                await expect(repository.findOneDevice('any-id')).rejects.toThrow('DynamoDB error');
            });
        });
    });
    ...
    describe('upsertOneDevice', () => {
        ...
        describe('when DynamoDB throws an error', () => {
            it('should propagate the error', async () => {
                ...
                await expect(repository.upsertOneDevice(mockDevice as Device)).rejects.toThrow('DynamoDB error');
            });
        });
    });
